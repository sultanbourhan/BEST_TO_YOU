...
import "../Update_company/Update_company.css"; // تأكد من تعديل المسار إذا كان مختلفًا
...
export default function Update_company_me() {
  ...
  const Create_companys = (event) => {
    ...
    if (companyImage === null && logoImage === null) {
      ...
      if (companyImage !== null) {
        console.log('Appending companyImage:', companyImage);
        formData.append('companyImage', companyImage); // تأكد من أنه من نوع File
      }
      if (logoImage !== null) {
        console.log('Appending logoImage:', logoImage);
        ...
        <form onSubmit={Create_companys} encType="multipart/form-data">
          <div className='inputs'>
            <div className="coolinput">
              ...
              <input type="text" placeholder="Name" className="input" value={name_c} onChange={(e) => setname_c(e.target.value)} />
            </div>
            ...
            <div className='img_upd_'>
              <div className='img_upd_1'>
                ...
                <label htmlFor="companyImage" className="text">Company Image:</label>
              ...
              <div className='img_upd_1'>
                <p>{logoImage_err}</p>
                <label htmlFor="logoImage" className="text">Logo Image:</label>
            ...
            <div className="coolinput">
              ...
              <textarea placeholder="Description" className="input" value={description} onChange={(e) => setDescription(e.target.value)}></textarea>
            </div>

            <div className="coolinput">
              <p>{phone_err}</p>
              <label htmlFor="input" className="text">Phone:</label>
            ...
            <div className="coolinput">
              <p>{country_err}</p>
              <label htmlFor="input" className="text">Country:</label>
              <input type="text" placeholder="Country" className="input" value={country} onChange={(e) => setCountry(e.target.value)} />
            </div>
            ...
            <div className="coolinput">
              <p>{street_err}</p>
              <label htmlFor="input" className="text">Street:</label>
              <input type="text" placeholder="Street" className="input" value={street} onChange={(e) => setStreet(e.target.value)} />
            </div>
